...
export type Tab = 'gestao' | 'dashboard' | 'whatsapp' | 'agenda' | 'rotinas' | 'financeiro' | 'relatorios' | 'configuracoes';
...
export const TabNavigation: React.FC<TabNavigationProps> = ({ activeTab, setActiveTab }) => {
    return (
        <nav className="border-b border-slate-700">
            <div className="flex flex-wrap gap-1 md:gap-2 pb-2">
                {tabs.map(tab => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center whitespace-nowrap px-3 py-2 text-sm font-medium rounded-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-blue-400 ${
                                isActive 
                                ? 'bg-slate-800/50 border-b-2 border-blue-400 text-blue-300' 
